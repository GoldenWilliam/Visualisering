...
plot_field_lines(
    ...
    steps=1000,
    save_path=f"img/metsim_fieldlines_euler_{seeding_strategy}_1000_1000.png"
)

plot_field_lines(
    X, Y, u, v, seeds, velocity_func, nx, ny, rk4_integrator,
    steps=1000,
    save_path=f"img/metsim_fieldlines_rk4_{seeding_strategy}_1000_1000.png"
)
