...
plt.axis('off')
plt.savefig("img/metsim_velocity_magnitude.png", bbox_inches='tight', pad_inches=0)
plt.title("Metsim Velocity Magnitude")
...
plt.axis('off')
plt.savefig("img/metsim_vorticity_magnitude.png", bbox_inches='tight', pad_inches=0)
plt.title("Metsim Vorticity Magnitude")
